...
public final class LightningTrail extends Entity {
    ...
    @Override protected void defineSynchedData() { this.entityData.define(ROUTE,new CompoundTag()); }
    ...
    public static boolean create(ServerLevel level,YangJian owner,int shape,Vec3 anchor,Vec3 end,Vec3 center,
        ...
        route.putLong("time",level.getGameTime());route.putInt("life",Mth.clamp(lifetime,0,80));
